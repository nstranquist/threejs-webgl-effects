...
import BurgerModelLink from '../assets/models/burger.glb'
...
// const ROCKET_URI = "/rocket.glb" // in /public
// const BURGER_URI = "/burger.glb" // in /public
...
useGLTF.preload(BurgerModelLink)
    ...
    <StyledApp id="canvas-container">
      ...
      <Canvas dpr={[1.5, 2]} linear shadows>
        ...
        <Suspense fallback={<Html><p style={{color:"#fff"}}>Loading Model...</p></Html>}>
          ...
          <BurgerModel url={BurgerModelLink} />
        </Suspense>
