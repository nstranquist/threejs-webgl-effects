import { WebGLRenderTarget, Object3D, MathUtils } from "three"
...
export default function Diamonds() {
  ...
  useFrame(() => {
    state.diamonds.forEach((data, i) => {
      ...
      data.pos.set(mobile ? 0 : x, MathUtils.lerp(data.pos.y, -sectionHeight * offset * factor + (state.top.current / state.zoom) * factor, 0.1), 0)
