...
const ScrollEffects1 = () => {
  ...
  return (
    <StyledScrollEffects1 id="canvas-container">
      <Canvas
        shadows
...
const StyledScrollEffects1 = styled.div`
html,
body,
#root {
  margin: 0;
...
body {
  cursor: url('/images/scroll1/ellipse.svg'), pointer;
  cursor: -webkit-image-set(url('/images/scroll1/ellipse.svg') 1x, url('/images/scroll1/ellipse.svg') 2x), pointer;
  background: #272727;
